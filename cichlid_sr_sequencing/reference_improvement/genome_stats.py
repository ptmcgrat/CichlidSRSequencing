...
pyfaidx_obj = Fasta('/Users/kmnike/Data/CichlidSequencingData/Genomes/temp/GCF_000238955.4_M_zebra_UMD2a_genomic.fna') # replace the filepath with the path to each dgenies genome when u run the script 

with open('/Users/kmnike/Desktop/UMD2a.csv', 'w') as fh: 
