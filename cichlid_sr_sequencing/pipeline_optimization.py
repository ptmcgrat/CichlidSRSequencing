...
for contig in test_contigs:
    sp.run(shlex.split(f'gatk SplitIntervals -R /home/ad.gatech.edu/bio-mcgrath-dropbox/interval_testing/genome/GCF_000238955.4_M_zebra_UMD2a_genomic.fna --scatter-count 4 -O /home/ad.gatech.edu/bio-mcgrath-dropbox/interval_testing --subdivision-mode BALANCING_WITHOUT_INTERVAL_SUBDIVISION -L {contig}'))