...
ind_depth <- read_delim("cohort.idepth", delim = "\t",
...
var_depth <- read_delim("cohort.ldepth.mean", delim = "\t",
...
var_site_depth <- read_delim("cohort.ldepth", delim = "\t",
...
ind_miss  <- read_delim("cohort.imiss", delim = "\t",
...
var_miss <- read_delim("cohort.lmiss", delim = "\t",
...
var_freq <- read_delim("cohort.frq", delim = "\t",
...
ind_het <- read_delim("cohort.het", delim = "\t",
...
var_qual <- read_delim("cohort.lqual", delim = "\t",
