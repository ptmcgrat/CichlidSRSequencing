...
ind_depth <- read_delim("419_cohort.idepth", delim = "\t",
...
var_depth <- read_delim("419_cohort.ldepth.mean", delim = "\t",
...
var_site_depth <- read_delim("419_cohort.ldepth", delim = "\t",
...
ind_miss  <- read_delim("419_cohort.imiss", delim = "\t",
...
var_miss <- read_delim("419_cohort.lmiss", delim = "\t",
...
var_freq <- read_delim("419_cohort.frq", delim = "\t",
...
ind_het <- read_delim("419_cohort.het", delim = "\t",
...
var_qual <- read_delim("419_cohort.lqual", delim = "\t",
