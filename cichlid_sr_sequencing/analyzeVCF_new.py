...
malawi_vcf = fm_obj.localMasterDir + 'Outputs/FilteredFiles/Mzebra_GT3/FilteredFilesGT3Cohort/MalawiIndividuals.vcf'
...
subprocess.run(['python3', '-m', 'vcf2phylip','-i',malawi_vcf, '-m', '150','-o',fm_obj.localMasterDir + 'Outputs/FilteredFiles/Mzebra_GT3/FilteredFilesGT3Cohort/'])

for lg,region in inversions.items():
    lg_vcf = fm_obj.localMasterDir + 'Outputs/FilteredFiles/Mzebra_GT3/FilteredFilesGT3Cohort/MalawiIndividuals_' + lg + '.vcf.gz'
    subprocess.run(['python3', '-m', 'vcf2phylip','-i',lg_vcf, '-m', '150','-o', fm_obj.localMasterDir + 'Outputs/FilteredFiles/Mzebra_GT3/FilteredFilesGT3Cohort/'])
...
###########################################################
yellowhead_samples = s_dt[s_dt.Organism == 'Aulonocara Nhkata Yellow Head'].SampleID.to_list()
yellowhead_vcf = fm_obj.localMasterDir + 'Outputs/FilteredFiles/Mzebra_GT3/FilteredFilesGT3Cohort/YellowHeadIndividuals.vcf'
parallel_filter(main_vcf, yellowhead_vcf, yellowhead_samples)
subprocess.call(['vcftools','--vcf',yellowhead_vcf,'--relatedness2','--out',yellowhead_vcf.replace('.vcf','.relatedness.txt')])
