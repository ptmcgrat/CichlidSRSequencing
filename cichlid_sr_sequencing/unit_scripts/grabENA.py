...
if args.Local:
	...
	print('  Patrick says Fastq files acsping for ' + args.RunID + ', Time:' + str(datetime.datetime.now()))
	for i in range(3):
...
if args.LibraryLayout == 'PAIRED':
	...
	with open(fixed_fq1, 'w') as outfq1:
		for r1 in f1:
			if r1.name == '' or r1.sequence == '' or r1.quality == '':
				continue
			elif r1.name is None or r1.sequence is None or r1.quality is None:
				continue
			else:
				outfq1.write('@' + r1.name + ' 1:N:0:2\n' + r1.sequence + '\n+\n' + r1.quality + '\n')
