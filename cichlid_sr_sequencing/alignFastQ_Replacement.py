...
parser.add_argument('-n', '--NumberParallel', type = int, default = 48, help = 'Specify the number of samples run in parallel. Default is 48')
...
parser.add_argument('-a', '--AnalysisType', nargs = '+', type = str, help = 'Chose samples based on a specific Anaalysis group in SampleDatabase_v2 e.g. PhylogenyFigure. Pass in analyses separated by commas e.g. PhylogenyFigure,YHPedigree')
...
fm_obj.setSamples(projectIDs = args.ProjectIDs, sampleIDs = args.SampleIDs, ecogroupIDs = args.Ecogroups, analysisType=args.AnalysisType)
