...
# filters = {'allele_freq':0, 'inbreeding_test':0, 'depth_Qual':0, 'max_DP':0, 'min_DP':0, 'strand_bias':0, 'mapping_quality':0, 'no_calls':0}
...
# with open('/home/ad.gatech.edu/bio-mcgrath-dropbox/Data/CichlidSequencingData/Outputs/vcf_concat_output/master_file_filtered.vcf', 'r') as fh:
#    for line in fh:
#       if line.strip().split()[0].startswith('##') or line.strip().split()[0].startswith('#'):
#          continue
#       filter = line.split('\t')[6]
